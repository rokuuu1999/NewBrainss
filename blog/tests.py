...
class ArticleTest(TestCase):
    ...
    def test_validate_article(self):
        ...
        user = BlogUser.objects.get_or_create(
            email="rokuuu1999@gmail.com",
            username="rokuuu1999")[0]
        user.set_password("qq229574683")
        user.is_staff = True
        ...
        u = gravatar_url('rokuuu1999@gmail.com')
        u = gravatar('rokuuu1999@gmail.com')
    ...
    def test_validate_feed(self):
        ...
        user.set_password("qq229574683")
        user.save()
        self.client.login(username='rokuuu1999', password='rokuuu1999')
